...
│   ├── INDEX.md
│   └── HS-2026-NN.md
├── weekly-reports/              Weekly syntheses (week-01 … week-09)
├── curriculum/
...
## Coverage
Fifty-five scheduled runs (29 May – 26 July 2026): **52 genuine lessons**, **2 non-productive** (RUN-004 advisory, RUN-009 null API error), **1 partial** (RUN-006). Null/partial runs are recorded, not omitted. *Weeks 04–05 re-taught foundations in all 14 sessions; week-07 fully regressed. **Weeks 08–09 (13–26 Jul) added 12 genuine sessions: nine foundational repeats and three genuinely new lessons (RUN-046 conception vs reduction to practice, RUN-049 witnessing patent-vs-GxP, RUN-050 retrospective reconstruction) that reactivated the five-week-starved HS-2026-02.** Prior-run detection across those 12: 0 success, 2 partial, 10 failed — the three advances were topic coincidences, not detected gaps. RUN-034 (2 Jul) remains the only session ever to advance *by* reading its own history. Gaps: 12 Jun, one indeterminable day in 3–5 Jul, and **18–19 Jul**. See `CONTROL-REGISTER.md` §4 and the weekly syntheses.*
...
Reconstructive compilation built 2026-06-15 from verified session transcripts — openly flagged, not backdated; weeks 04–09 (RUN-017…055) filed reconstructively at the 2026-06-22, 2026-06-30, 2026-07-06, 2026-07-13 and 2026-07-27 audits. **The scheduled 2026-07-20 audit did not run** — disclosed in `CONTROL-REGISTER.md` §6 — which is why RUN-044…048 carry an 11–14 day filing lag instead of ≤7. Stated + weekday-correct dates: 29 May, 8/13/14/15/16/22/25/26/28/30 Jun, 2/7/13/14/15/23/26 Jul; RUN-054 states 25 Jul without a weekday; RUN-022 states 20 Jun but mislabels the weekday; RUN-026 states 24 Jun without a weekday; all others inferred (±1 day). RUN-047 and RUN-050 are inferred but corroborated by internal worked-example dates; **RUN-048, 049, 051 and 053 are inferred from session order alone with no corroboration — the weakest dating in the record, flagged on each sheet.** Apparent gaps: 12 Jun, one indeterminable day in 3–5 Jul, and **18–19 Jul** (the previously flagged 29 Jun gap is corrected: RUN-031 fills it). SHA-256 hashes in `run-sheets/INDEX.md`; git history and the bundle are the immutable trail. Going forward, filing each run sheet on its own session day makes the chain fully contemporaneous.
