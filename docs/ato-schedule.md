...
- **2026-07-27** (weekly audit — covers the missed 20 Jul slot as well): instructions page re-checked via WebSearch **and** full `web_fetch` of the instructions URL. Page still **"Last updated 30 May 2026"**, metadata `dcterms.modified` **2026-05-29T22:22:00+00:00**, QC **107004** unchanged, schedule year still **2026**. On-page reconfirmation of: the **$20,000** notional-deduction floor with RSP/CRC exceptions, Parts A–E, item **21** labels **W** (clawback) and **X** (balancing-adjustment catch-up), item 6 label Q / item 7 label D preliminaries, consolidated-group single-schedule rule, TR 2021/5 ('at risk'), TA 2023/5 (overseas for foreign related entities), s 355-405, s 355-415 intra-group mark-ups, subdiv 355-E / s 355-520 depreciating assets, and Div 27 GST adjustment. Search results list 2024, 2025 and 2026 instruction sets only — **no 2027 schedule published**. No change to this file's substance.
